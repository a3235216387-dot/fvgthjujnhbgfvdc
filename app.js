...
async function main() {
    const UUID = await getVariableValue('UUID', '41d9fb43-c80e-4ba2-91ea-9d37b3d34650'); // 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
    ...
    const DOMAIN = await getVariableValue('DOMAIN', 'https://dcrfvgbhnj.g1-us-east.galaxycloud.app/');// 为保证安全隐蔽，建议留空，可在Node.js界面下的环境变量添加处（Environment variables）,点击ADD VARIABLE，修改变量
